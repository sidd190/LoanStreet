...
function CampaignsPageContent() {
  ...
  const [selectedCampaignForProgress, setSelectedCampaignForProgress] =
  ...
  const calculateDeliveryRate = (campaign: Campaign) => {
    return campaign.totalSent > 0
      ? Math.round((campaign.totalDelivered / campaign.totalSent) * 100)
      : 0;
  };

  const calculateResponseRate = (campaign: Campaign) => {
    return campaign.totalDelivered > 0
      ? Math.round((campaign.totalReplies / campaign.totalDelivered) * 100)
      : 0;
  };
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Create, manage, and track your SMS, WhatsApp, and email marketing
              campaigns
            </p>
          </div>
          <button
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        {["RUNNING", "PAUSED", "SCHEDULED"].includes(
                          ...
                          <button
                            onClick={() =>
                              setSelectedCampaignForProgress(campaign.id)
                            }
                            className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg"
                            title="View Progress"
                          >
